...
try {
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tabelpeminjaman SET 
                anggotaid = :anggotaid,
                bukuid = :bukuid, 
                petugasid = :petugasid,
...
<body class="bg-light">
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 p-4">
            <div class="container">
                <h2 class="mb-4"><i class="fas fa-edit me-2"></i>Edit Peminjaman</h2>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="anggotaid" required>
                                    ...
                                    <?php foreach($anggota as $a): ?>
                                        <option value="<?= $a['anggotaid'] ?>" <?= $peminjaman['anggotaid'] == $a['anggotaid'] ? 'selected' : '' ?>>
                                            <?= $a['namaanggota'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="bukuid" required>
                                    ...
                                    <?php foreach($buku as $b): ?>
                                        <option value="<?= $b['bukuid'] ?>" <?= $peminjaman['bukuid'] == $b['bukuid'] ? 'selected' : '' ?>>
                                            <?= $b['judulbuku'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="petugasid" required>
                                    ...
                                    <?php foreach($petugas as $p): ?>
                                        <option value="<?= $p['petugasid'] ?>" <?= $peminjaman['petugasid'] == $p['petugasid'] ? 'selected' : '' ?>>
                                            <?= $p['namapetugas'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggalpinjam" value="<?= $peminjaman['tanggalpinjam'] ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="tanggalkembali" class="form-label">Tanggal Kembali</label>
                                <input type="date" class="form-control" name="tanggalkembali" value="<?= $peminjaman['tanggalkembali'] ?>" required>
                            </div>
