...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        $sql = "INSERT INTO tabelanggota (namaanggota, alamat, tanggallahir, kontak) 
                VALUES (:namaanggota, :alamat, :tanggallahir, :kontak)";
    ...
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-plus me-2"></i>Tambah Anggota</h2>
