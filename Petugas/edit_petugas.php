    ...
    <div class="d-flex">
        ...
        <div class="content flex-grow-1 p-4">
            <div class="container">
                ...
                if(isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $sql = "SELECT * FROM tabelpetugas WHERE petugasid = ?";
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $petugas['namapetugas']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="kontak" class="form-label">Kontak:</label>
                                <input type="text" class="form-control" id="kontak" name="kontak" value="<?php echo $petugas['kontak']; ?>" required>
                            </div>
                            <div class="mb-3">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    try {
                        $sql = "UPDATE tabelpetugas SET namapetugas = ?, kontak = ?, jabatan = ? WHERE petugasid = ?";
                        $stmt = $conn->prepare($sql);
                        $stmt->execute([$nama, $kontak, $jabatan, $id]);
                        echo "<div class='alert alert-success mt-3'>Data petugas berhasil diupdate!</div>";
                        echo "<script>window.location.href = 'list_petugas.php';</script>";
